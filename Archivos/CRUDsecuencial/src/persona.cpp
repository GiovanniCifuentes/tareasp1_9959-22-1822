...
persona::persona(string id, string name, string phone, string college, string address)
{
    this->id = id;
    this->name = name;
    this->phone = phone;
...
string persona::setPhone(string phone)
{
    this->phone = phone;
}
...
// Setter y Getter de college
string persona::setCollege(string college)
{
    this->college = college;
}
string persona::getCollege()
{
    return this->college;
}

// Setter y Getter de address
string persona::setAddress(string address)
{
    this->address = address;
}
